...
\author{Rishabh~Tripathi~(24BRS1136)~and~Saumya~(24BRS1065)% TODO: Saumya's full name
\thanks{Manuscript prepared September 24, 2026, for the DA2 project review
and viva evaluation. \textit{(Project guide: Vijayaprabhakaran~K.)}
The authors are with the Department of Computer Science and Engineering,
[Institution], India. % TODO: replace [Institution] with the institution name
